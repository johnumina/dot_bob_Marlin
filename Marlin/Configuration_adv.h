...
#define PWM_MOTOR_CURRENT { 1200, 1000, 500 }          // Values in milliamps
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 70*60, 70*60, 10*60, 80 } // Feedrates for manual moves along X, Y, Z, E from panel
