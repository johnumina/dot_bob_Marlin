...
#define HOTEND_OFFSET_X {0.0, 32.30} // (mm) relative X-offset for each nozzle
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 8, 60 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 50, 6000}
